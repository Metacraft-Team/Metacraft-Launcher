export const METACRAFT_SERVICES_URL = process.env.VITE_API_URL
export const JAVA17_MANIFEST_URL = `${process.env.VITE_API_URL}/configs/openjdk17.json`
export const JAVA_MANIFEST_URL = `${process.env.VITE_API_URL}/configs/openjdk17.json`

export const MC_MANIFEST_URL = 'https://launchermeta.mojang.com/mc/game/version_manifest.json'
...
export const FABRIC_LOADER_VERSION = '0.13.3'
...
export const MICROSOFT_OAUTH_REDIRECT_URL = 'https://login.microsoftonline.com/common/oauth2/nativeclient'
export const MINECRAFT_SERVICES_URL = 'https://api.minecraftservices.com'
export const MC_STARTUP_METHODS = { SYMLINK: 'Symlink', DEFAULT: 'Default' }
